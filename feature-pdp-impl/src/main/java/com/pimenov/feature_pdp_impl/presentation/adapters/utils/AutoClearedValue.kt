package com.pimenov.feature_pdp_impl.presentation.adapters.utils
...
class AutoClearedValue<T : Any>(fragment: Fragment, event: Lifecycle.Event, value: T) : ReadWriteProperty<Fragment, T> {
